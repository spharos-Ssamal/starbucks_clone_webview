...
import style from './ListPeriodStatusModal.module.css'

export interface ListPeriodStatusModalProps {
    isModalOpen: boolean;
    setIsModalOpen: Dispatch<SetStateAction<boolean>>;
}
export default function ListPeriodStatusModal({isModalOpen, setIsModalOpen}:ListPeriodStatusModalProps) {
  ...
  return (
    ...
    <div className="flex-between purchase-list-option">
        <div>
            <label htmlFor="purchase-list-category">주문 유형</label><br />
