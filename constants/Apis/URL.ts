...
export const REQUEST_LOGOUT = "api/auth/v1/logout";
export const REQUEST_REISSUE_JWT_TOKEN = "api/auth/v1/reissue";

export const REQUEST_REGISTER = "api/v1/user/register";
export const REQUEST_VERIFY_EMAIL = "api/v1/user/email/verify";
export const REQUEST_DUPLICATION_CHECK_ID = "api/v1/user/username/confirm"
export const REQUEST_DUPLICATION_CHECK_NICKNAME = "api/v1/user/userNickname/confirm"
...
export const REQUEST_PAY_HISTORY = "api/v1/pay/users/history";
...
export const REQ_ADDRESS_ADD = "api/v1/address/add";
export const REQ_ADDRESS_EDIT = "api/v1/address/edit";
export const REQ_ADDRESS_all = "api/v1/address/all";
export const REQ_ADDRESS_DELETE = "api/v1/address/delete";